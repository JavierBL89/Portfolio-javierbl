...
function ProjectCard(props){
    ...
    return (
            ...
            <div className="container-fluid project-card">
                <div className="row">
                    ...
                    <div className="project-card-body">
                            <div className="row g-0">
                                 <div data-aos="fade-down-left" className="col-12 project-description">
                                 <small>{props.description}
                                     </small> 
                                  </div>
                                  <div data-aos="fade-down-left" className="col-12 d-lg-none project-tech">
                ...
                <div data-aos="fade-down-left" className="col-12 d-none d-lg-flex project-tech-large">
                    {props.technology?.map((tech, index) => {
                        return (<img key={index} src={tech.icon} alt={tech.name}/>)
                        })}
                </div>
